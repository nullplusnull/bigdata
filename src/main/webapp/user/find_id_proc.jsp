...
<DIV class='title_line'>알림</DIV>
    ...
    <fieldset class='fieldset_basic'>
      <ul>
        ...
        <c:when test="${userVO != null }">
          <li class='li_none'>${userVO.username} 회원의 ID는 ${userVO.userid}</li>
        </c:when>
        <c:otherwise>
  ...
  <div class="form-group">
      <div class="col-md-offset-5 col-md-7">
        ...
        <button type='button' onclick="location.href='./find_pw.do'" class="btn btn-primary btn-md">비밀번호찾기</button>
      </div>
    </div>
