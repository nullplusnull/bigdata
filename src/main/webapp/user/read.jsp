...
<DIV class='content' style='width: 90%;'> 
  ...
  <FORM name='frm' id='frm' method='POST' action='./update.do' 
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-md" name='username' id='username' 
                   value='${userVO.username }' required="required" style='width: 30%;' placeholder="성명">
      </div>
    </div>   
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-md" name='usertel' id='usertel' 
                   value='${userVO.usertel }' required="required" style='width: 30%;' placeholder="전화번호"> 예) 010-0000-0000
      </div>
    </div>   
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-md" name='userzipcode' id='userzipcode' 
                   value='${userVO.userzipcode }' required="required" style='width: 30%;' placeholder="우편번호">
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-md" name='useraddress1' id='useraddress1' 
                   value='${userVO.useraddress1 }' required="required" style='width: 80%;' placeholder="주소">
      </div>
    </div>   
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-md" name='useraddress2' id='useraddress2' 
                   value='${userVO.useraddress2 }' required="required" style='width: 80%;' placeholder="상세 주소">
      </div>
    </div>   
...
<!-- ----- DAUM 우편번호 API 종료----- -->
      ...
      <div class="form-group">   
        <label for="filesMF" class="col-md-1 control-label">면허사진</label>
        <div class="col-md-2">
          <IMG id='userthumb' src='./storage/${userVO.userthumb }'>       
        </div>
        <div class="col-md-10">
