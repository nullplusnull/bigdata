...
<script type="text/javascript">
  ...
  function panel_img(file){
    var panel = '';
    panel += "<DIV id='panel' class='popup_img' style='width: 80%; margin:0px auto;'>";
...
<DIV class='content'>   
  ...
  <ASIDE style='float: left;'>
    ...
    <A href='./list.do?cateno=${categrp_CateVO.cateno }'>${categrp_CateVO.title }
  </ASIDE>
  <ASIDE style='float: right;'>
    ...
    <span class='menu_divide' >│</span> 
    <A href='./create.do?cateno=${categrp_CateVO.cateno }'>등록</A>
    <span class='menu_divide' >│</span> 
    <A href='./reply.do?cateno=${categrp_CateVO.cateno }&contentsno=${contentsVO.contentsno }'>답변</A>
    <span class='menu_divide' >│</span> 
    <A href='./list_by_cateno_search_paging.do?cateno=${categrp_CateVO.cateno }&word=${param.word}&nowPage=${param.nowPage}'>목록</A>
    <span class='menu_divide' >│</span> 
    <A href='./update.do?cateno=${categrp_CateVO.cateno }&contentsno=${contentsVO.contentsno }&nowPage=${param.nowPage}'>수정</A>
    <span class='menu_divide' >│</span> 
    <A href='./delete.do?contentsno=${contentsVO.contentsno }&cateno=${categrp_CateVO.cateno }&nowPage=${param.nowPage}'>삭제</A>
  </ASIDE> 
  </c:if>
